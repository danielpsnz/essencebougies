      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">       
        <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2">
                ...
                {features.map((feature) => (
                  <div key={feature.name} className="relative pl-9">
                    <dt className="inline font-semibold text-gray-900 dark:text-gray-100">
                      <feature.icon aria-hidden="true" className="absolute left-1 top-1 h-8 w-7 -ml-3 text-indigo-300" />
                      {feature.name}
                    </dt>{' '}
          ...
          <img
            ...
            src="https://cdn.shopify.com/s/files/1/0751/2460/5195/files/IMG_2473.jpg?v=1727282136"
            width={2432}
            height={1442}
